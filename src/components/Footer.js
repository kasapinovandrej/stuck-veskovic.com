                    ...
                    <div className='footer__textwrap'>
                        <div className="footer__box">
                            <div className="footer__textbox">
                                ...
                                <a href="tel:004917641552816" className='footer__link'>0176 415 528 16</a>
                        ...
                        <div className="footer__box">
                            <div className="footer__textbox">
                                <h4>FOLGE UNS</h4>
                                <div>
                                    <a target="_blank" rel="noreferrer" href="https://www.facebook.com/profile.php?id=100014241640083" className='footer__link'><RiFacebookBoxFill className="footer__icon" /></a>
                                    <a target="_blank" rel="noreferrer" href="https://www.instagram.com/veskovicpergola" className='footer__link'><RiInstagramLine className="footer__icon" /></a>
                                    {/* <a target="_blank" rel="noreferrer" href="" className='footer__link'><RiLinkedinBoxFill className="footer__icon" /></a> */}
                                </div>
                            </div>
                        </div>
                    </div>
